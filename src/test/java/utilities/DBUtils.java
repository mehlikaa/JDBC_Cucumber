...
public class DBUtils {
        ...
        private static Connection connection;   // baska classlardan ulasilamaz ama buradaki
        private static Statement statement;     // classlardakilerin degerini degistirip kullanabilmeleri icin
        ...
        public static void createConnection() {
            ...
            try {                         //baska classlardan exceptionla ugrasmiyorduk
        ...
        public static Connection getConnection() {     //olan baglantiyi kullaniyoruz
            String url="jdbc:sqlserver://184.168.194.58:1433;databaseName=hotelmycamp ; user=techproed;password=P2s@rt65";
            String username="techproed";
            String password="P2s@rt65";
            try {
